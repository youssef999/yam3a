...
"Yamaa":"يمعة",
      ...
      'start_conversation': 'ابدأ المحادثة مع العلامة التجارية',
      'type_message': 'اكتب رسالة...',
      'message_sent': 'تم إرسال الرسالة',
      'failed_to_send_message': 'فشل في إرسال الرسالة',
      'failed_to_load_messages': 'فشل في تحميل الرسائل',
      'chat_started': 'تم بدء المحادثة. اهلاً وسهلاً!',
      'user_not_logged_in': 'المستخدم غير مسجل الدخول',
      'phone_call_feature_coming_soon': 'ميزة المكالمات الهاتفية قريباً',
      'file_attachment_coming_soon': 'ميزة إرفاق الملفات قريباً',
      'now': 'الآن',
      'brand_email_not_available': 'بريد العلامة التجارية غير متوفر',
      ...
      'start_chatting_with_brands': 'ابدأ المحادثة مع العلامات التجارية لتظهر هنا',
      'visit_brands_to_chat': 'قم بزيارة العلامات التجارية لبدء المحادثة',
      'active_chats': '{count} محادثة نشطة',
      'search_chats': 'البحث في المحادثات',
      'search_feature_coming_soon': 'ميزة البحث قريباً',
      'failed_to_load_chats': 'فشل في تحميل المحادثات',
      'retry': 'إعادة المحاولة',
      'delete_chat': 'حذف المحادثة',
      'delete_chat_confirmation': 'هل أنت متأكد من حذف هذه المحادثة؟ سيتم حذف جميع الرسائل.',
      'delete': 'حذف',
      'open_chat': 'فتح المحادثة',
      'chat_deleted_successfully': 'تم حذف المحادثة بنجاح',
      'failed_to_delete_chat': 'فشل في حذف المحادثة',
      'yesterday': 'أمس',
      'monday': 'الاثنين',
      'tuesday': 'الثلاثاء',
      'wednesday': 'الأربعاء',
      ...
      'select_receive_date': 'اختر تاريخ الاستلام',
      'select_when_receive_order': 'متى تريد استلام طلبك؟',
      'receive_date': 'تاريخ الاستلام',
      'selected_date': 'التاريخ المحدد',
      'not_specified': 'غير محدد',
      'no_items_selected': 'لم يتم اختيار أي عناصر للطلب',
      
      // Review translations
      'rate_and_review': 'تقييم ومراجعة',
      'how_was_your_experience': 'كيف كانت تجربتك؟',
      'rate_each_item_help_others': 'قيّم كل عنصر لمساعدة الآخرين',
      'overall_rating': 'التقييم العام',
      'item_number': 'العنصر رقم',
      'rate_this_item': 'قيّم هذا العنصر',
      'out_of_5': 'من 5',
      'write_comment': 'اكتب تعليق',
      'share_your_experience': 'شارك تجربتك مع هذا العنصر...',
      'submit_review': 'إرسال التقييم',
      'submitting_review': 'جاري إرسال التقييم...',
      'please_rate_and_comment_all_items': 'يرجى تقييم والتعليق على جميع العناصر',
      'review_submitted_successfully': 'تم إرسال التقييم بنجاح',
      'failed_to_submit_review': 'فشل في إرسال التقييم. حاول مرة أخرى',
      
      // Brand Reviews translations
      'brand_reviews': 'تقييمات الماركة',
      'view_reviews': 'عرض التقييمات',
      'no_ratings_yet': 'لا توجد تقييمات بعد',
      'reviews': 'تقييمات',
      'review': 'تقييم',
      'failed_to_load_reviews': 'فشل في تحميل التقييمات',
      'be_first_to_review': 'كن أول من يقيم هذه الماركة',
      'no_reviews': 'لا توجد مراجعات',
      'anonymous_user': 'مستخدم مجهول',
      'checking_review_status': 'جاري التحقق من حالة التقييم...',
  ...
  'No products found': 'لا توجد منتجات',
      ...
      'minimum_order_policy': 'سياسة الحد الأدنى للطلب',
      'minimum_order_applied': 'تم تطبيق الحد الأدنى للطلب',
      'minimum_order_explanation': 'الحد الأدنى للطلب هو',
      'you_will_pay': 'ستدفع',
      ...
      // Premium and Contact strings - Arabic
      'premium_mode': 'الوضع المميز',
      'yamaa_premium': 'يمعة بريميوم',
      'unlock_premium_experience': 'افتح تجربة مميزة',
      'premium_description': 'مع الاشتراك المميز يمكنك التواصل مع اصحاب المحال التجارية رسالة او هاتف ',
      'loading_premium_price': 'جاري تحميل سعر البريميوم...',
      'failed_to_load_price': 'فشل في تحميل السعر',
      'premium_price': 'سعر البريميوم',
      'bd_currency': 'دينار',
      'per_month': '/شهر',
      'best_value_premium': 'أفضل قيمة للميزات المميزة',
      'premium_features': 'ميزات البريميوم',
      'priority_support': 'دعم أولوي',
      'priority_support_desc': 'دعم عملاء مميز على مدار الساعة',
      'exclusive_features': 'ميزات حصرية',
      'exclusive_features_desc': 'الوصول للميزات المميزة فقط',
      'faster_processing': 'معالجة أسرع',
      'faster_processing_desc': 'معالجة أولوية للطلبات',
      'special_discounts': 'خصومات خاصة',
      'special_discounts_desc': 'عروض وصفقات حصرية',
      'subscribe_for_price': 'اشترك بـ {price}',
      'subscribe_to_premium': 'اشترك في البريميوم',
      'refresh_price': 'تحديث السعر',
      'premium_subscription': 'اشتراك بريميوم',
      'subscribe_unlock_features': 'اشترك بـ {price} لفتح الميزات المميزة!',
      
      // Brand contact strings - Arabic
      'call_brand': 'اتصال بالعلامة التجارية',
      'message_brand': 'رسالة للعلامة التجارية',
      'cannot_make_call': 'لا يمكن إجراء مكالمة هاتفية',
      'phone_call': 'مكالمة هاتفية',
      'tap_to_call_brand': 'اضغط للاتصال بالعلامة التجارية',
      'cannot_send_message': 'لا يمكن إرسال رسالة',
      'message': 'رسالة',
      'tap_to_contact_brand': 'اضغط للتواصل مع العلامة التجارية',
      
      // Phone and WhatsApp strings - Arabic
      'phone_not_available': 'رقم الهاتف غير متاح',
      'phone_call_failed': 'فشل في إجراء المكالمة',
      'cannot_open_whatsapp': 'لا يمكن فتح واتساب',
      'whatsapp_failed': 'فشل في فتح واتساب',

      // Notification strings - Arabic
      'notifications': 'الإشعارات',
      'notification_controls': 'التحكم في الإشعارات',
      'add_test_notification': 'إضافة إشعار تجريبي',
      'add_5_test_notifications': 'إضافة 5 إشعارات تجريبية',
      'clear_all_notifications': 'مسح جميع الإشعارات',
      'adding_notification': 'جاري إضافة الإشعار...',
      'adding_notifications': 'جاري إضافة الإشعارات...',
      'clearing_notifications': 'جاري مسح الإشعارات...',
      'confirm_clear': 'تأكيد المسح',
      'confirm_clear_message': 'هل أنت متأكد من مسح جميع الإشعارات؟ لا يمكن التراجع عن هذا الإجراء.',
      ...
      'no_notifications_desc': 'ليس لديك أي إشعارات بعد. سنرسل لك إشعاراً عند حدوث شيء مهم.',
      'notification_added_successfully': 'تم إضافة الإشعار بنجاح',
      'notifications_added_successfully': 'تم إضافة الإشعارات بنجاح',
      'failed_to_add_notification': 'فشل في إضافة الإشعار',
      'notification_marked_read': 'تم تمييز الإشعار كمقروء',
      'notification_marked_unread': 'تم تمييز الإشعار كغير مقروء',
      ...
      'notification_days_ago': 'أيام مضت',
      'notification_hours_ago': 'ساعات مضت',
      'notification_minutes_ago': 'دقائق مضت',
      'notification_just_now': 'الآن',
      'notification_details': 'تفاصيل الإشعار',
      'no_title': 'بدون عنوان',
      'no_message': 'بدون رسالة',
      'notification_total': 'الإجمالي',
      'notification_read': 'مقروء',
      'notification_unread': 'غير مقروء',
      'notification_type': 'النوع',
      'notification_email': 'البريد الإلكتروني',
      'read_status': 'الحالة',
      'test_notification_added': 'تم إضافة إشعار تجريبي بنجاح',
      'failed_to_add_notifications': 'فشل في إضافة الإشعارات',
      'all_notifications_read': 'تم تمييز جميع الإشعارات كمقروءة',
      'notification_unknown_date': 'تاريخ غير معروف',
      
      // FCM Notification related translations
      'notification_sent_successfully': 'تم إرسال الإشعار بنجاح',
      'failed_to_send_notification': 'فشل في إرسال الإشعار',
      'notification_send_error': 'خطأ في إرسال الإشعار',
      'notification_sent_to_devices': 'تم إرسال الإشعار إلى {success} من أصل {total} أجهزة',
      'new_message_from': 'رسالة جديدة من {name}',
      'order_status_update': 'تحديث حالة الطلب',
      'order_status_changed': 'تم تغيير حالة الطلب {orderId} إلى {status}',
    ...
    'en': {
      ...
      'start_conversation': 'Start conversation with the brand',
      'type_message': 'Type a message...',
      'message_sent': 'Message sent',
      'failed_to_send_message': 'Failed to send message',
      'failed_to_load_messages': 'Failed to load messages',
      'chat_started': 'Chat started. Welcome!',
      'user_not_logged_in': 'User not logged in',
      'phone_call_feature_coming_soon': 'Phone call feature coming soon',
      'file_attachment_coming_soon': 'File attachment feature coming soon',
      'now': 'now',
      'brand_email_not_available': 'Brand email not available',
      ...
      'start_chatting_with_brands': 'Start chatting with brands to see them here',
      'visit_brands_to_chat': 'Visit brands to start chatting',
      'active_chats': '{count} active chats',
      'search_chats': 'Search chats',
      'search_feature_coming_soon': 'Search feature coming soon',
      'failed_to_load_chats': 'Failed to load chats',
      'retry': 'Retry',
      'delete_chat': 'Delete Chat',
      'delete_chat_confirmation': 'Are you sure you want to delete this chat? All messages will be deleted.',
      'delete': 'Delete',
      'open_chat': 'Open Chat',
      ...
      'select_when_receive_order': 'When would you like to receive your order?',
      'receive_date': 'Receive Date',
      'selected_date': 'Selected Date',
      'not_specified': 'Not Specified',
      'no_items_selected': 'No items selected for order',
  ...
  'no_services_found': 'No services found',
      ...
      'minimum_order_policy': 'Minimum Order Policy',
      'minimum_order_applied': 'Minimum Order Applied',
      'minimum_order_explanation': 'Minimum order requirement is',
      ...
      // Review translations - English
      'rate_and_review': 'Rate & Review',
      'how_was_your_experience': 'How was your experience?',
      'rate_each_item_help_others': 'Rate each item to help others',
      'overall_rating': 'overall rating',
      'item_number': 'Item #',
      'rate_this_item': 'Rate this item',
      'out_of_5': 'out of 5',
      'write_comment': 'Write a comment',
      'share_your_experience': 'Share your experience with this item...',
      'submit_review': 'Submit Review',
      'submitting_review': 'Submitting review...',
      'please_rate_and_comment_all_items': 'Please rate and comment on all items',
      ...
      // Brand Reviews translations - English
      ...
      'be_first_to_review': 'Be the first to review this brand',
      'no_reviews': 'No reviews',
      'anonymous_user': 'Anonymous User',
      'checking_review_status': 'Checking review status...',
      'review_submitted': 'Review Submitted',
      ...
      // Premium and Contact strings
      'premium_mode': 'Premium Mode',
      'yamaa_premium': 'Yamaa Premium',
      'unlock_premium_experience': 'Unlock Premium Experience',
      'premium_description': 'With the premium subscription, you can communicate with shop owners by sending a message or giving them a call.',
      'loading_premium_price': 'Loading Premium Price...',
      'failed_to_load_price': 'Failed to load price',
      'premium_price': 'Premium Price',
      'bd_currency': 'BD',
      'per_month': '/month',
      'best_value_premium': 'Best Value for Premium Features',
      'premium_features': 'Premium Features',
      'priority_support': 'Priority Support',
      'priority_support_desc': '24/7 premium customer support',
      'exclusive_features': 'Exclusive Features',
      'exclusive_features_desc': 'Access to premium-only features',
      'faster_processing': 'Faster Processing',
      'faster_processing_desc': 'Priority order processing',
      'special_discounts': 'Special Discounts',
      'special_discounts_desc': 'Exclusive deals and offers',
      'subscribe_for_price': 'Subscribe for {price}',
      'subscribe_to_premium': 'Subscribe to Premium',
      'refresh_price': 'Refresh Price',
      'premium_subscription': 'Premium Subscription',
      'subscribe_unlock_features': 'Subscribe for {price} to unlock premium features!',
      
      // Brand contact strings
      'call_brand': 'Call Brand',
      'message_brand': 'Message Brand',
      'cannot_make_call': 'Cannot make phone call',
      'phone_call': 'Phone Call',
      'tap_to_call_brand': 'Tap to call brand',
      'cannot_send_message': 'Cannot send message',
      'message': 'Message',
      'tap_to_contact_brand': 'Tap to contact brand',
      
      // Phone and WhatsApp strings - English
      ...
      'whatsapp_failed': 'WhatsApp failed to open',

      // Notification strings - English
      'notifications': 'Notifications',
      'notification_controls': 'Notification Controls',
      'add_test_notification': 'Add Test Notification',
      'add_5_test_notifications': 'Add 5 Test Notifications',
      'clear_all_notifications': 'Clear All Notifications',
      'adding_notification': 'Adding notification...',
      'adding_notifications': 'Adding notifications...',
      'clearing_notifications': 'Clearing notifications...',
      'confirm_clear': 'Confirm Clear',
      'confirm_clear_message': 'Are you sure you want to clear all notifications? This action cannot be undone.',
      ...
      'no_notifications_message': 'You have no notifications at the moment.',
      'no_notifications': 'No Notifications',
      'no_notifications_desc': 'You don\'t have any notifications yet. We\'ll notify you when something important happens.',
      'notification_added_successfully': 'Notification added successfully',
      'notifications_added_successfully': 'Notifications added successfully',
      'failed_to_add_notification': 'Failed to add notification',
      ...
      'notification_hours_ago': 'hours ago',
      ...
      'read_status': 'Status',
      'test_notification_added': 'Test notification added successfully',
      'failed_to_add_notifications': 'Failed to add notifications',
      'all_notifications_read': 'All notifications marked as read',
      'notification_unknown_date': 'Unknown date',
